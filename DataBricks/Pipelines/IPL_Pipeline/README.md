...
This folder defines all source code for the 'IPL_Pipeline' pipeline:
...
* Take a look at the sample under "sample_users_ipl_pipeline.py" to get familiar with the syntax.
